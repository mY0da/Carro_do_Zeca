...
10.times do
  ...
  car =  {brand: car_brand, car_type: Faker::Vehicle.drive_type, model: car_model, registration_plate: Faker::Vehicle.license_plate, description: Faker::Movie.quote, location: Faker::Address.city, price: Faker::Number.decimal(l_digits: 3, r_digits: 3), user_id: i}
